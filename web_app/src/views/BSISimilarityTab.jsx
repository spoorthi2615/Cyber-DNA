...
export default function BSISimilarityTab({ data }) {
  const bsiData = data.dashboard_computed_metrics?.bsi_distribution || [];
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#10b981]/10 border border-[#10b981]/30 rounded p-4 text-sm text-[#10b981] flex items-center justify-between">
        <span className="font-semibold">Verified Computed BSI Distribution</span>
        ...
        <div className="h-[350px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={bsiData} margin={{ top: 20, right: 30, left: 0, bottom: 25 }}>
              ...
              <Bar dataKey="benign_benign" name="Benign-Benign Pairs" stackId="a" fill="#0ea5e9" radius={[0, 0, 0, 0]} />
              <Bar dataKey="benign_malicious" name="Benign-Malicious Pairs" stackId="a" fill="#f59e0b" radius={[0, 0, 0, 0]} />
              <Bar dataKey="malicious_malicious" name="Malicious-Malicious Pairs" stackId="a" fill="#ef4444" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
